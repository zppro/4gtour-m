<template lang="jade">
  .hot-list-c
    ...
    .hot-list(v-if="experiencesHot.length > 0" v-infinite-scroll="appendHotList", infinite-scroll-disabled="appendHotDiabled", infinite-scroll-distance="infiniteScrollDistance")
